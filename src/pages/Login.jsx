      ...
      <div className="hero h-full" style={{ backgroundImage: `url(${login})` }}>
        ...
        <div className="w-full lg:max-w-md max-w-sm p-8 my-10 space-y-3 rounded-xl bg-gray-800 text-gray-100 bg-opacity-50">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="form-control text-black">
              ...
              <div className="relative mb-3 ">
                <input
                  ...
                  name="password"
                  className="w-full py-3 px-4 input input-bordered bg-gray-900 text-white"
                ...
                >
                  {showEye ? <IoEyeOutline /> : <FaRegEyeSlash />}
                </span>
              </div>
              <label className="label">
                <a
            ...
            <button className="block w-full p-3 text-center rounded-sm text-gray-900 bg-white">
              Sign in
            </button>
          </form>
